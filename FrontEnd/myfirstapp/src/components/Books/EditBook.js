            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                <div className="form-group">
                  <select className="form-control" onChange={this.onChange} name="name" required={true}>
                    {
...
export default connect(mapStateToProps, { createBook, getAllCategories })(EditBook);
